...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        ...
        // counter indexing
        controller.y().whileTrue(robotState.seekIndefinite(IndexerState.REVERSE, SpindexerState.REVERSE))
        ...
        aimbotHeld
                ...
                .onFalse(robotState.seek(SpindexerState.IDLE, IndexerState.IDLE, IntakePivotState.DRIVING_POS));
